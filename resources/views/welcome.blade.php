            ...
            <div class="carousel-container" id="showroom-carousel">
                <div class="carousel-slides">
                    ...
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 2">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 3">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 4">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 5">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 6">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 7">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 8">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 9">
                    </div>
                    <div class="carousel-slide">
                        <img class="w-full h-auto rounded-lg" src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/site/srsDvBFG6CY05EuX8HCx.webp" alt="Showroom Image 10">
                    </div>
                </div>
