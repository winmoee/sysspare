                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div id="feature2" class="hidden border-t border-gray-200 bg-gray-50">
                        <div class="md:flex md:flex-row-reverse md:items-start">
                            ...
                            <div class="p-4 md:w-2/3 md:pl-8">
                                <p class="text-sm text-gray-600 mt-2 leading-8">
                                    YM358R, L1 မော်ဒယ်တွင်သာ ပါရှိသည်။ ထယ်ရေးအနက် ထိန်းညှိစနစ်သည် ထယ်ရေးအနက်ဆူး လွန်လာသည့် အချိန်များတွင် စက်အား ဝန်ပိုမှုမရှိစေဘဲ အလိုအလျောက် ထိန်းညှိပေးသော စနစ်ဖြစ်ပါသည်။ ဝန်ပိုရုန်းဆွဲ နေရသောကြောင့် ကြန့်ကြာနိုင်သည့်အချိန်များကို လျှော့ချပေးနိုင်သလို ထယ်ရေးအနက် ထိန်းညှိစနစ်ကြောင့် လုပ်ငန်းခွင်ကို လျင်မြန်စွာ ပြီးမြောက်နိုင်ပါသည်။
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div id="feature4" class="hidden border-t border-gray-200 bg-gray-50">
                        <div class="md:flex md:flex-row-reverse md:items-start">
                            ...
                            <div class="p-4 md:w-2/3 md:pl-8">
                                <p class="text-sm text-gray-600 mt-2 leading-8">
                                    ဒီဇယ်ဆီတိုင်ကီသည် ဆီပမာဏ ၅၀ လီတာကို သိုလှောင်နိုင်သောကြောင့် တနေ့တာ အလုပ်လုပ်ဆောင်ချိန်အတွင်း ထပ်မံ ဖြည့်တင်းရန်မလိုပါ။
                                </p>
                            </div>
                        </div>
                    </div>
