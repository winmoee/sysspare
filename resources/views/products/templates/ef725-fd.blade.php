                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div class="catalog-image flex-shrink-0">
                                <img src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/0main/products/yanmar/book725.webp" 
                            ...
                            <a href="https://drive.google.com/uc?export=download&id=1pMAeRcWtNNmor724XYjzArQPKrhx-aus"
                                        class="text-green-600 hover:text-green-700 transition-colors duration-200"
                                        target="_blank">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-medium text-gray-800">EF725 FD</h4> <!-- Keep specific title -->
