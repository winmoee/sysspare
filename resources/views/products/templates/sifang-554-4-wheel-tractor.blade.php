        ...
        <div class="max-w-7xl mx-auto py-6 lg:py-8">
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                        <div class="flex items-center">
                            <span class="text-lg font-medium text-gray-700 text-left">ဆီစားနှုန်းသက်သာ </span>
                        </div>
                        <svg
                            id="arrowFeature4"
                            class="w-5 h-5 text-gray-500 transform transition-transform duration-200 flex-shrink-0 ml-4"
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                        <div class="flex items-center">
                            <span class="text-lg font-medium text-gray-700 text-left">Power Steering ပါဝင်ခြင်း </span>
                        </div>
                        <svg
                            id="arrowFeature7"
                            class="w-5 h-5 text-gray-500 transform transition-transform duration-200 flex-shrink-0 ml-4"
                    ...
                    <div id="feature7" class="hidden border-t border-gray-200 bg-gray-50">
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div class="p-4 md:w-2/3 md:pl-8">
                                    <p class="text-sm text-gray-600 mt-2 leading-8">
                                        လက်တွေနဲ့ အားမသုံးပဲ လှည့်နိုင်ခြင်း
                                        များ ဆောင်ရွက် နိုင်ပါတယ်။ Steering Wheel ကို သေးသေးလေး လှည့်လျှင် အင်ဂျင်မှ Hydraulic က ကူညီပေးတယ်။
                                        လယ်ထဲ၊ ကျဉ်းသော နေရာများအတွင်းမှာလည်း လျင်မြန်လှည့်နိုင်ပါသည်။
                                        မောင်းနှင်သူ လက်နာကျင်ခြင်း၊ ပင်ပန်းမှုများ လည်း လျော့ နည်း စေ ပြီး သက်သာ စေပါသည်။
                                        Power Steering ပါဝင်ခြင်းကြောင့် Steering Wheel ကို အလွယ်တကူ လှည့်နိုင်ပါသည်။လယ်ထဲ ကွေ့ကောက်နေရာများ၊ နေရာကျဉ်းသော လယ်ယာလမ်းများတွင်လည်း မောင်း နှင်းရ လွယ် ကူ နိုင်ပါသည်။
                                    </p>
                                </div>
