            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a  class="block">
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="relative aspect-[4/3] w-full">
                                <img
                                    src="https://www.yanmar.com/media/news/2020/01/17005956/img_index_034.jpg"
                                    class="w-full h-full object-cover rounded-t-lg"
                                >
                        </div>
                        <div class="p-4">
                        <h6 class="text-l font-semibold text-gray-800 mb-2">၁။ Maru လက်ကိုင်ကိုပြောင်းလဲ အသုံးပြုခြင်း
                        </h6>
                            <p class="text-sm text-gray-600 mt-2 leading-8">ရိုးရှင်းသည့် Maru လက်ကိုင် လှည့်အားဖြင့် Crawler နှစ်ဖက်လုံးကို ထိန်းချုပ်နိုင်ခြင်းသည် Yanmar ၏မူလနည်းစနစ်ဖြစ်ပါသည်။အလွယ်တကူ ကွေ့ရလွယ်ကူသည့် Maru လက်ကိုင်ကို ရိတ်ခြွေစက်တွင် ပြောင်းလဲ အသုံးပြူခြင်းဖြင့် သင့်ရဲ့ရိတ်သိမ်းသည့် အလုပ်ပိုမိုလျင်မြန်ပြီးမြောက်မည်ဟု ဆိုလိုပါသည်။</p>
                        </div>
                    </div>
                </a>
                <a  class="block">
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="relative aspect-[4/3] w-full">
                                <img
                                    src="https://www.yanmar.com/media/news/2020/01/17010043/img_index_043.jpg"
                                    class="w-full h-full object-cover rounded-t-lg"
                                >
                        </div>
                        <div class="p-4">
                        <h6 class="text-l font-semibold text-gray-800 mb-2">၂။ စွမ်းအင်အပြည့် အသုံးပြုနိုင်ခြင်း ၊ ဆီစားသက်သာခြင်း
                        </h6>
                            <p class="text-sm text-gray-600 mt-2 leading-8">ဆလင်ဒါလေးလုံး စုစုပေါင်းထုထည် (၃၃၁၈) စီစီပမာဏနှင့် မြင်းကောင်ရေ (၈၅) ကောင် ရှိသော ဒီဇယ်အင်ဂျင်တပ်ဆင် ထားသောကြောင့် အမြင့်ဆုံးပါဝါနှင့် အကောင်းဆုံးဆလင်ဒါအတွင်း မီးလောင်ပေါက်ကွဲနိုင်မှု စွမ်းရည်ရှိသည်။ဒီဇယ်ဆီစားနှုန်းသက်သာစေသော တိုက်ရိုက်ဒီဇယ် ဆီအင်ဂျက်ရှင်းစနစ်ကို အသုံးပြုထားသည်။</p>
                        </div>
                    </div>
                </a>
                <a  class="block">
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="relative aspect-[4/3] w-full">
                                <img
                                    src="https://www.yanmar.com/media/news/2020/01/17010124/img_index_053.jpg"
                                    class="w-full h-full object-cover rounded-t-lg"
                                >
                        </div>
                        <div class="p-4">
                        <h6 class="text-l font-semibold text-gray-800 mb-2">၃။ ဂီယာဘောက် ဒီဇိုင်းအသစ်
                        </h6>
                            <p class="text-sm text-gray-600 mt-2 leading-8">ပျက်စီးလွယ် အစိတ်အပိုင်းများအား အသုံးပြုထားခြင်းမရှိသောကြောင့် မလိုလားအပ်သော ကုန်ကျမှုများ နည်းသွားစေခြင်း</p>
                        </div>
                    </div>
                </a>
                <a  class="block">
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="relative aspect-[4/3] w-full">
                                <img
                                    src="https://www.yanmar.com/media/news/2020/01/17010210/img_index_063.jpg"
                                    class="w-full h-full object-cover rounded-t-lg"
                                >
                        </div>
                        <div class="p-4">
                        <h6 class="text-l font-semibold text-gray-800 mb-2">၄။ ဆီသိုလှောင်ကန်</h6>
                            <p class="text-sm text-gray-600 mt-2 leading-8">ဒီဇယ်ဆီတိုင်ကီ သိုလှောင်နိုင်မှုပမာဏသည် ၁၁၅ လီတာ သိုလှောင်နိုင် သောကြောင့် တစ်နေ့တာအလုပ်ုလပ်နေစဉ်အတွင်း ဆီထပ်မံဖြည့်ရန် မလိုအပ်ပါ။</p>
                        </div>
                    </div>
                </a>
                <a  class="block">
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="relative aspect-[4/3] w-full">
                                <img
                                    src="https://www.yanmar.com/media/news/2020/01/17010255/img_index_074.jpg"
                                    class="w-full h-full object-cover rounded-t-lg"
                                >
                        </div>
                        <div class="p-4">
                        <h6 class="text-l font-semibold text-gray-800 mb-2">၅။ မြေပြင်ကင်းလွတ်ခွင့် 460 mm                          </h6>
                            <p class="text-sm text-gray-600 mt-2 leading-8">အလုပ်လုပ်နေစဉ်တွင် ဂီယာဘောက်ကို ရိုးပြတ်များနှင့် ကောင်းစွာကင်းလွတ်နိုင်ရုံသာမက မြေပြင်မှလည်း လုံလောက်သောအကွာအဝေး လွတ်ကင်းသည့်အတွက် လယ်ကွက်တစ်ကွက်နှင့်တစ်ကွက် ပြောင်းရွှေ့ရိတ်သိမ်းရာတွင်လည်း မပြောင်းလဲသော လုပ်ဆောင်မှုကို ရရှိမည် ဖြစ်သည်။
                            </p>
                        </div>
                    </div>
                </a>
                <a  class="block">
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="relative aspect-[4/3] w-full">
                                <img
                                    src="https://www.yanmar.com/media/news/2020/01/17010333/img_index_08.jpg"
                                    class="w-full h-full object-cover rounded-t-lg"
                                >
                        </div>
                        <div class="p-4">
                        <h6 class="text-l font-semibold text-gray-800 mb-2">၆။ လွယ်ကူစွာ ပြုပြင်ထိန်းသိမ်းနိုင်ခြင်း
                        </h6>
                            <p class="text-sm text-gray-600 mt-2 leading-8">စပါးခြွေလှေ့ခန်းအဖုံးများအား လွယ်ကူစွာဖွင့်ပြီး ပြုပြင် ထိန်းသိမ်းနိုင်သည်။</p>
                        </div>
                    </div>
                </a>
                <a  class="block">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div class="catalog-image flex-shrink-0">
                                <img src="https://sys-shop.s3.ap-southeast-1.amazonaws.com/0main/products/yanmar/bookyh700.avif" 
                            ...
                            <a href="https://drive.google.com/uc?export=download&id=1g0jqGTrm3krtY88ZZWr-weemZFTH_iHc"
                                        class="text-green-600 hover:text-green-700 transition-colors duration-200"
                                        target="_blank">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-medium text-gray-800">YH700/YH850</h4> <!-- Keep specific title -->
