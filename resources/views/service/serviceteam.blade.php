    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div class="aspect-w-16 aspect-h-9">
            <iframe
                ...
                <!-- Contact Section -->
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h4 class="text-xl font-semibold text-green-600 mb-4">Contacts</h4>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <!-- Contact 1 -->
                <div class="p-4 border rounded-lg">
                    <h5 class="font-medium text-gray-600">Ma Khin Myo Than</h5>
                    <br>
                ...
                <div class="p-4 border rounded-lg">
                    <h5 class="font-medium text-gray-600">Ma Cherry Htar</h5>
                    <br>
                ...
                <div class="p-4 border rounded-lg">
                    <h5 class="font-medium text-gray-600">Ko Pyae Phyo Htun</h5>
                    <br>
