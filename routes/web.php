...
// Add these new catalog routes
Route::get('/catalog/yanmar', function () {
    return view('catalog.yanmar');
})->name('catalog.yanmar');

Route::get('/catalog/ace', function () {
    return view('catalog.ace');
})->name('catalog.ace');

Route::get('/catalog/sifang', function () {
    return view('catalog.sifang');
})->name('catalog.sifang');

Route::get('/catalog/otherbrands', function () {
    return view('catalog.otherbrands');
})->name('catalog.otherbrands');
...
Route::get('/aboutspare', function () {
    return view('aboutspare');
})->name('aboutspare');
